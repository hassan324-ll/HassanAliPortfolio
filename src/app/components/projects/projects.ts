...
export class Projects implements OnInit {
  ...
  projects = [
      {
      title: 'North Valley Tyres',
      description: 'A modern website for a tyre agency or shop and other services like wheel alignment and dent repairs, with a clean design and responsive layout.',
      image: '/northvalley.png',
      tech: ['Angular', 'TypeScript', 'Bootstrap', 'Css', 'HTML'],
      live: 'https://northvalleytyres-e1m2.vercel.app/',
      repo: 'https://github.com/hassan324-ll/eliyafoundation',
      category: 'web',
      photos: ['./eliya.png'],
    },
    {
      title: 'Eliya Foundation Charity Website',
      description: 'A modern charity website using angular with a clean design and responsive layout, Also used payment integration system so user can pay donation through cards and mobile payments.',
      image: '/eliya.png',
      tech: ['Angular', 'TypeScript', 'Bootstrap'],
      live: 'https://eliyafoundationtrust.vercel.app/',
      repo: 'https://github.com/hassan324-ll/eliyafoundation',
      category: 'web',
      photos: ['./eliya.png'],
    },
    {
      ...
      tech: ['Angular', 'TypeScript', 'Bootstrap'],
      live: '#',
      repo: 'https://github.com/hassan324-ll/chinese-restaurant',
      category: 'web',
    ...
    },
    {
      ...
      live: 'https://driver-eight-zeta.vercel.app/login',
      repo: 'https://github.com/hassan324-ll/Driver',
      category: 'web',
      photos: [
        '/login.png',
        '/active jobs.png',
